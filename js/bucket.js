...
function Bucket(x,y){
	...
	*/
	this.destroy = function(){
		...
		//remove this bucket from the array. First, look up and store current the current bucket's index number in the array
		var this_bucket_index_num = bucketArray.indexOf(this);
		//remove exactly one bucket from the array, starting at the current bucket's index number
		bucketArray.splice(this_bucket_index_num, 1);
